...
/**
 * 电池View
 * Created at 2020/8/3 0003 11:10
 *
 * @author : LiYuliang
 * @version : 2020/8/3 0003 11:10
 */

public class BatteryView extends View {
    private int mMargin = 2;    //电池内芯与边框的距离
    private int mBoder = 2;     //电池外框的宽度
    private int mWidth = 45;    //总长
    private int mHeight = 25;   //总高
    private int mHeadWidth = 3;
    private int mHeadHeight = 5;
