...
public class CompanyProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.initToolBar(R.string.CompanyProfile, R.drawable.back_white, -1, -1, -1, onClickListener);
    ...
    private RobotLifecycleCallbacks robotLifecycleCallbacks = new RobotLifecycleCallbacks() {
        ...
        public void onRobotFocusGained(QiContext qiContext) {
            // 获得焦点
            Say say = SayBuilder.with(qiContext).withText(getString(R.string.introduction)).build();
            say.run();
        }
