...
public class EngineeringCaseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engineering_case);
        mContext = this;
        MyToolbar toolbar = findViewById(R.id.myToolbar);
        toolbar.initToolBar(R.string.EngineeringCase, R.drawable.back_white, -1, -1, -1, onClickListener);
    ...
    private RobotLifecycleCallbacks robotLifecycleCallbacks = new RobotLifecycleCallbacks() {
        ...
        public void onRobotFocusGained(QiContext qiContext) {
            // 获得焦点
            Say say = SayBuilder.with(qiContext).withText("工程案例").build();
            say.run();
        }
